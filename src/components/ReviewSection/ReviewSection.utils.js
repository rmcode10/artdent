export const reviews = [
  {
    ...
    name: "Gabriela  H.",
    rating: 5,
    text: "Am fost extrem de mulțumită de serviciile oferite de această clinică dentară. Întreaga experiență a fost fără durere și fără niciun fel de disconfort, iar aparatura este modernă și de ultimă generație. Echipa este tânără, profesionistă și foarte amabilă. Am apreciat în mod special faptul că am primit explicații clare pentru fiecare etapă a tratamentului, lucru care m-a făcut să mă simt în siguranță și bine informată. Spațiul este foarte curat, luminos și primitor, ceea ce creează o atmosferă plăcută încă de la intrare. În plus, clinica dispune și de locuri de parcare, ceea ce face vizita mult mai comodă. Recomand cu încredere!",
  ...
  },
  {
    ...
    name: "Maria R.",
    rating: 5,
    text: "Am fost la clinică pentru extracția unor molari de minte. Deși eram destul de anxioasă înainte, experiența a fost una foarte bună. Intervenția s-a desfășurat fără durere, iar recuperarea a fost ușoară. Atmosfera e calmă, personalul e atent și profesionist. O recomand cu toată încrederea!",
    date: "acum 3 luni",
  },
];
